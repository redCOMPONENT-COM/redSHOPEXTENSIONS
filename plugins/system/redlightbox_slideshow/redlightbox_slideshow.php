...
class PlgSystemRedlightbox_Slideshow extends JPlugin
{
    ...
    public function onBeforeRender()
    {
        ...
        JHtml::script('https://cdnjs.cloudflare.com/ajax/libs/photoswipe/4.1.3/photoswipe.min.js', false, true, false, false);
        JHtml::script('https://cdnjs.cloudflare.com/ajax/libs/photoswipe/4.1.3/photoswipe-ui-default.min.js', false, true, false, false);
