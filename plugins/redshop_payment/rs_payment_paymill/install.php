...
/**
 * Plg\Redshop_Paymentrs_Payment_Paymill installer class.
 *
 * @package  \Redshopb.Plugin
 * @since    2.0.0
 */
class Plg\Redshop_Paymentrs_Payment_PaymillInstallerScript
{
	/**
	...
	protected function deleteOldLanguages()
	{
		...
		// Remove old library
		$oldFolder = JPATH_ROOT . '/plugins/redshop_payment/rs_payment_paymill/rs_payment_paymill';
