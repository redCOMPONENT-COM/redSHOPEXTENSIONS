 ...
 * @subpackage  PlgRedshop_PaymentRs_Payment_BankTransfer_Discount
 *
...
/**
 *  PlgRedshop_PaymentRs_Payment_BankTransfer_Discount installer class.
 *
 * @package  \Redshopb.Plugin
 * @since    1.7.0
 */
class PlgRedshop_PaymentRs_Payment_BankTransfer_DiscountInstallerScript
{
	/**
